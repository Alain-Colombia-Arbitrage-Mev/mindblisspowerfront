      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} transition={{ duration: 0.8 }}
            ...
            <p>Todo el contenido de la plataforma, incluyendo texto, gráficos, logos, imágenes, software y bases de datos, es propiedad de Mindbliss Power o sus proveedores autorizados. Los derechos de autor y otras leyes de propiedad intelectual protegen este contenido. Sin la autorización expresa escrita de Mindbliss Power, los usuarios no pueden reproducir, distribuir, modificar o transmitir cualquier material de la plataforma.</p>

            <h2 className="font-montserrat font-bold text-3xl text-vicion-deep mt-12 mb-6">5. Limitación de Responsabilidad</h2>
            <p>Mindbliss Power proporciona la plataforma "tal como está" sin garantías de ningún tipo, ni expresas ni implícitas. En la medida máxima permitida por la ley, Mindbliss Power no será responsable por daños indirectos, incidentales, especiales, consecuentes o punitivos derivados de:</p>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <p>Aunque Mindbliss Power se esfuerza por mantener la plataforma disponible continuamente, no puede garantizar una disponibilidad sin interrupciones. La plataforma puede estar temporalmente indisponible debido a mantenimiento, actualizaciones o circunstancias fuera del control de Mindbliss Power. Mindbliss Power no será responsable por tales interrupciones.</p>

            <h2 className="font-montserrat font-bold text-3xl text-vicion-deep mt-12 mb-6">7. Modificaciones de Términos</h2>
            <p>Mindbliss Power se reserva el derecho de modificar este aviso legal en cualquier momento. Los cambios se publicarán en la plataforma con una fecha de actualización. El uso continuado de la plataforma después de tales cambios constituye aceptación de los términos modificados.</p>

            <h2 className="font-montserrat font-bold text-3xl text-vicion-deep mt-12 mb-6">8. Terminación de Acceso</h2>
            <p>Mindbliss Power se reserva el derecho de suspender o terminar el acceso de cualquier usuario a la plataforma sin previo aviso, por cualquier razón, incluyendo violación de estos términos o conducta que Mindbliss Power considere inapropiada.</p>

            <h2 className="font-montserrat font-bold text-3xl text-vicion-deep mt-12 mb-6">9. Ley Aplicable y Jurisdicción</h2>
            <p>Este aviso legal se rige por las leyes aplicables en el contexto de operación de Mindbliss Power. Cualquier disputa relacionada con la plataforma será resuelta conforme a la ley competente y los procedimientos establecidos.</p>

            <h2 className="font-montserrat font-bold text-3xl text-vicion-deep mt-12 mb-6">10. Contacto</h2>
            <p>Para preguntas sobre este aviso legal o la plataforma, contacta a nuestro equipo de cumplimiento a través de los canales oficiales de Mindbliss Power.</p>
